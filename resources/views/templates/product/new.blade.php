      ...
      <div class="col-xl-10 col-md-12 d-flex flex-column mx-auto">
        <div class="card  mt-4">
          ...
          <div class="card-header">
            <h3 class="font-weight-black text-dark  text-center ">Enregistrement produit</h3>
              ...
              @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <div class="mb-3">
                        <input type="text" id="" name="name" class="form-control" required value="{{ old('name') }}" placeholder="Entrer le nom du produit">
                        </div>
                    ...
                    <div class="col-6">
                        ...
                        <span style="font-weight: bold; color:red">*</span>
                        <div class="mb-3">
                            <input type="number" step="0.01" name="priceHt" class="form-control"  value="{{ old('priceHt') }}" placeholder="Entrer le prix" required >
                        </div>
